    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                ...
                InlineKeyboardButton('channel', url='https://t.me/mallufilmcity') 
            ...
            [
                InlineKeyboardButton('Series & Movie Club', url=f'https://t.me/mallurockersclub_bot') 
        ...
        buttons = [[
            ...
            InlineKeyboardButton('😍 MALLUROCKERS CLUB BOT ♥️', url='https://t.me/mallurockersclub_bot')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.insert(0,
            [InlineKeyboardButton(text="⭕️ Join Our Channel ⭕️",url="https://t.me/mallurockersclub")]
        )
    else:
        btn.append(
