...
async def next_page(bot, query):
    ...
    btn.insert(0,
          [
                ...
                InlineKeyboardButton("⭕️ Movies Watch and Download", url="https://t.me/+GsFSpn-3xgwyYmNk"),
                InlineKeyboardButton("Movies Download  ⭕️", url="https://t.me/+eQEpIgvQwlo2ZDc0")
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/+UGGrObrnpIDK1qqq')
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Videos and Music', url='https://t.me/+Q15Kn9-J2tqnDr3j'),
            InlineKeyboardButton('Mallurockers Club ⭕️', url='https://t.me/+GsFSpn-3xgwyYmNk')
            ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('File store Bot', url='https://t.me/ngrockers_bot')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status videos', url='https://t.me/+Q15Kn9-J2tqnDr3j'),
