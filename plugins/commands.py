...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        if message.command[1] != "subscribe":
            ...
            btn.append([InlineKeyboardButton("🔄 Try Again 👈 Tap me 🥰", callback_data=f"{pre}#{message.command[1]}")])
    ...
    await client.send_cached_media(
        ...
        caption=f_caption,
        protect_content=True if pre == 'filep' else False,
        reply_markup=InlineKeyboardMarkup[[InlineKeyboardButton('support', url='https://t.me/JOSPSupport'),InlineKeyboardButton('channel', url='https://t.me/JosProjects')],[InlineKeyboardButton('Series & Movie Club', url=f'https://t.me/+y53tWFUw6Q43NzE9')]]
        )
